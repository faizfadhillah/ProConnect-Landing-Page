    ...
    <div style={{ maxWidth: 1080 }}>
      ...
      <div style={{ background: '#fff', borderRadius: 16, border: `1px solid ${PC.border}`, padding: mobile ? 20 : 28, marginBottom: 24 }}>
        ...
        <div style={{ background: PC.bg, borderRadius: 12, padding: '18px 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 18 }}>
          <div><div style={{ fontSize: 16, fontWeight: 800, color: PC.dark, fontFamily: 'Montserrat' }}>This organisation plan is active</div><div onClick={() => onUpgrade({ country, full, dept })} style={{ fontSize: 13.5, fontWeight: 600, color: PC.blue, fontFamily: 'Montserrat', cursor: 'pointer' }}>Upgrade anytime →</div></div>
